(() => {
  ...
  function T(e, t, a) {
    var c, b = null;
    try {
      (b = S()) ? (b.previous_page.path = b.page.path, b.previous_page.type = b.page.type, b.previous_page.id = b.page.id, b.previous_page.start = b.page.start, b.previous_page.pageview_id = b.page.pageview_id, b.page.path = e, b.page.type = t, b.page.id = a, b.page.start = Date.now(), b.page.pageview_id = r(), b.depth = I() + 1, b.expire = Date.now() + w) : b = function(e, t, a) {
        try {
          var s = n(v);
          if (s) {
            var c = JSON.parse(s);
            if (A(c, !0)) return c.previous_page.path = c.page.path, c.previous_page.type = c.page.type, c.previous_page.id = c.page.id, c.previous_page.start = c.page.start, c.previous_page.pageview_id = c.page.pageview_id, c.page.path = e, c.page.type = t, c.page.id = a, c.page.start = Date.now(), c.page.pageview_id = r(), c.depth = I() + 1, c.expire = Date.now() + w, c.tab_id = E(), o(v, JSON.stringify(c)), c
          }
        } catch (e) {
          var d = null;
          try {
        ...
        var l = r(),
          b = function() {
            var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
              ...
              O = m(a, "network");
            e = c || ("" === s && "" !== i ? "" : i);
            var D, L, M = !d || "poki" === e || f.has(e),
              B = (D = (i || "").match(/^android-app:\/\/([^/]+)/i)) ? D[1].toLowerCase() : null,
              N = function(e) {
            ...
            L = "chrome_extension" === v ? "poki_chrome_extension" : "edge_extension" === v ? "poki_edge_extension" : l ? "tiktok" : w ? "snapchat" : "android_app" === A ? "poki_android_app" : "web_app_manifest" === v ? "pwa" : B || N || R || (!d && v ? v : j || (M && S ? p(u(S)) || S : "g" === O ? "google" : "ytv" === O ? "youtube" : d || _ || E || I || T || P || x || C ? !d && _ && /^\d+$/.test(_) ? "direct" : "" === e && d ? "unknown" : e || "unknown" : "direct"));
            var V, G = h.has(L) || !!(_ || E || I || T || P || x || C) || "cpc" === b || "rtb-cpm" === b || "ppc" === b || "paid" === b,
              F = (s || "").toLowerCase(),
              U = !g.has(F) && (y.has(L) || /^com\.google\.android\.googlequicksearchbox$/.test(F) || /^webcache\.googleusercontent\.com$/.test(F) || !!k && "share" !== b);
            return V = "snapchat" === v ? "cpc" : P && !v ? "organic" : G ? "cpc" : U ? "organic" : g.has(F) ? "oauth" : "pwa" === L || "poki_android_app" === L || d || "social" === b || "email" === b ? "referral" : L ? "unknown" : "direct", "direct" === L && "direct" !== V && "unknown" !== V && "referral" !== V && (L = "unknown"), h.has(L) && (L = "unknown"), "poki" === L && "cpc" === V && (L = "unknown"), {
              source: L,
              medium: V
            }
          }({
  ...
  const C = (e, t) => {
    ...
    O = () => "undefined" != typeof navigator && /(?:phone|windows\s+phone|ipod|blackberry|(?:android|bb\d+|meego|silk|googlebot) .+? mobile|palm|windows\s+ce|opera mini|avantgo|mobilesafari|docomo|kaios)/i.test(navigator.userAgent),
  ...
  const M = C("referrer") || "",
    ...
    N = {
      ...
      device: O() ? "mobile" : D() ? "tablet" : "desktop",
      experiment: C("experiment") || "",
      forceAd: C("force_ad") || !1,
      isPokiIframe: (parseInt(C("site_id"), 10) || 0) > 0,
      isPokiExternal: !!window.isPokiExternal,
      siteID: parseInt(C("site_id"), 10) || 3,
      tag: C("tag") || "",
      versionID: C("game_version_id"),
      debugMode: "true" === C("pokiDebug"),
      logMode: "" !== C("pokiLogging"),
      testVideos: "true" === C("testVideos"),
      referrerParam: M,
      isPlayground: !!window.isPokiPlayground,
      isInspector: "inspector-uploads.poki-user-content.com" === window?.location?.host || document?.referrer?.includes("inspector.poki.dev") || "1" === C("inspector"),
      houseAdsOnly: !1,
      adOverrideMode: !1,
      googlePreview: !!C("google_preview"),
      ccpaApplies: "1" === B || "0" !== B && void 0,
      country: (C("country") || "").toUpperCase(),
      gameID: C("game_id"),
      gdprApplies: (R = (C("country") || "").toUpperCase(), x.includes(R)),
      contentGameID: void 0,
      specialCondition: C("special_condition"),
      nonPersonalized: "y" === C("nonPersonalized"),
      familyFriendly: "y" === C("familyFriendly"),
      kioskMode: "y" === C("kioskMode") || !!window?.kioskMode,
      forceBidder: C("force_bidder") || "",
      cloudSaveGames: "y" === C("cloudsavegames"),
      AYMode: L.ON,
      forceStartAY: "y" === C("forceStartAY")
    };
  var R;
  const j = (e, t) => {
      N[e] = t
  ...
  const $ = (e, t) => {
      ...
      return null !== n && (n.constructor.name === t.name || $(n, t))
    },
  ...
  function Z(e, t = {}) {
    const n = $(e, SVGElement) ? "svg" : "html",
      o = Q[n];
    if (o) return o;
    const r = t.includeStyleProperties ?? Y(window.getComputedStyle(document.documentElement)),
      i = "html" === n ? r.filter((e => !J.has(e))) : [...r];
    return Q[n] = i, i
  }
  ...
  function re(e, t, n, o) {
    const r = `.${e}:${t}`,
      i = n.cssText ? function(e) {
        ...
        return Z(document.documentElement, t).map((t => `${t}: ${e.getPropertyValue(t)}${e.getPropertyPriority(t)?" !important":""};`)).join(" ")
      }(n, o);
  ...
  const ae = "application/font-woff",
    se = "image/jpeg",
    ce = {
      woff: ae,
      woff2: ae,
  ...
  async function ge(e, t, n) {
    ...
    if (null != me[o]) return me[o];
    let r;
    n.cacheBust && (e += (/\?/.test(e) ? "&" : "?") + (new Date).getTime());
    try {
      const o = await pe(e, n.fetchRequestInit, (({
        res: e,
        result: n
  ...
  async function he(e, t) {
    return $(e, HTMLCanvasElement) ? async function(e) {
      try {
        if (e.getContext("2d")) return ne(e.toDataURL())
      } catch {}
      if (0 === e.width || 0 === e.height) return ne("data:,");
      const t = document.createElement("canvas").getContext("2d", {
        alpha: !0
      });
      t.canvas.width = e.width, t.canvas.height = e.height;
      const n = t.getImageData(0, 0, t.canvas.width, t.canvas.height);
      return ne(await new Promise((o => {
        try {
    ...
    }(e): $(e, HTMLVideoElement) ? async function(e, t) {
      if (e.currentSrc) {
        const t = document.createElement("canvas"),
          n = t.getContext("2d");
        return t.width = e.clientWidth, t.height = e.clientHeight, n?.drawImage(e, 0, 0, t.width, t.height), ne(t.toDataURL())
      }
      const {
        poster: n
      } = e, o = de(n);
      return ne(await ge(n, o, t))
    }(e, t): $(e, HTMLIFrameElement) ? async function(e, t) {
      try {
        if (e?.contentDocument?.body) return await be(e.contentDocument.body, t, !0)
      } catch {}
      return e.cloneNode(!1)
    }(e, t): e.cloneNode(ye(e))
  }
  const fe = e => "SLOT" === e.tagName?.toUpperCase(),
    ye = e => null != e.tagName && "SVG" === e.tagName.toUpperCase();
  ...
  function we(e, t, n) {
    return function(e, t, n) {
      ...
      r.cssText ? (o.cssText = r.cssText, o.transformOrigin = r.transformOrigin) : Z(e, n).forEach((n => {
        let i = r.getPropertyValue(n);
        if ("font-size" === n && i.endsWith("px")) {
          const e = Math.floor(parseFloat(i.substring(0, i.length - 2))) - .1;
          i = `${e}px`
        }
        $(e, HTMLIFrameElement) && "display" === n && "inline" === i && (i = "block"), "d" === n && t.getAttribute("d") && (i = `path(${t.getAttribute("d")})`), o.setProperty(n, i, r.getPropertyPriority(n))
      }))
    }(e, t, n), $(e, HTMLElement) && $(t, HTMLElement) && (function(e, t) {
      ...
      ie(e, t, ":before", n), ie(e, t, ":after", n)
  ...
  async function be(e, t, n) {
    return n || !t.filter || t.filter(e) ? W(e) ? (ve++, ve % 5 == 0 && await (o = 0, e => new Promise((t => {
      setTimeout((() => t(e)), o)
    }))), Promise.resolve(e).then((e => he(e, t))).then((n => async function(e, t, n) {
      if (ye(t)) return t;
      let o = [];
      return o = fe(e) && e.assignedNodes ? Y(e.assignedNodes()) : $(e, HTMLIFrameElement) && e.contentDocument?.body ? Y(e.contentDocument.body.childNodes) : Y(("shadowRoot" in e ? e.shadowRoot ?? e : e).childNodes), 0 === o.length || $(e, HTMLVideoElement) || await o.reduce(((e, o) => e.then((() => be(o, n))).then((e => {
        e && t.appendChild(e)
      }))), Promise.resolve()), t
    }(e, n, t))).then((n => we(e, n, t))).then((e => async function(e, t) {
  ...
  const ke = /url\((['"]?)([^'"]+?)\1\)/g,
    Ae = /url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g,
    Se = /src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;
  async function _e(e, t, n, o, r) {
    try {
  ...
  async function Ie(e, t, n) {
    ...
    const o = function(e, {
      ...
      r = function(e) {
        const t = [];
        return e.replace(ke, ((e, n, o) => (t.push(o), e))), t.filter((e => !le(e)))
      }(o);
    return r.reduce(((e, o) => e.then((e => _e(e, o, t, n)))), Promise.resolve(o))
  }
  async function Te(e, t, n) {
    const o = t.style?.getPropertyValue(e);
    if (o) {
      const r = await Ie(o, null, n);
      return t.style.setProperty(e, r, t.style.getPropertyPriority(e)), !0
    }
    return !1
  }
  async function Pe(e, t) {
    W(e) && (await async function(e, t) {
      await Te("background", e, t) || await Te("background-image", e, t), await Te("mask", e, t) || await Te("mask-image", e, t)
    }(e, t), await async function(e, t) {
      const n = $(e, HTMLImageElement),
        o = $(e, SVGImageElement);
      if ((!n || le(e.src)) && (!o || le(e.href.baseVal))) return;
      ...
      const n = Y(e.childNodes).map((e => Pe(e, t)));
  ...
  async function Oe(e, t) {
    ...
    const o = /url\(["']?([^"')]+)["']?\)/g,
      r = (n.match(/url\([^)]+\)/g) || []).map((async r => {
        let i = r.replace(o, "$1");
        return i.startsWith("https://") || (i = new URL(i, e.url).href), pe(i, t.fetchRequestInit, (({
          result: e
  ...
  async function Le(e, t) {
      ...
      o = await async function(e, t) {
        ...
        return e.forEach((n => {
          if ("cssRules" in n) try {
            Y(n.cssRules || []).forEach(((e, r) => {
              if (e instanceof CSSImportRule) {
                let i = r + 1;
                const a = Ce(e.href).then((e => Oe(e, t))).then((e => De(e).forEach((e => {
                  try {
            ...
            null != n.href && o.push(Ce(n.href).then((e => Oe(e, t))).then((e => De(e).forEach((e => {
    ...
    return function(e) {
      return e.filter((e => e instanceof CSSFontFaceRule)).filter((e => Ee(e.style.getPropertyValue("src"))))
    }(o)
  }
  ...
  async function Be(e, t = {}) {
    const {
      width: n,
      height: o
    } = ee(e, t), r = await be(e, t, !0);
    await Me(r, t), await Pe(r, t),
      function(e, t) {
        const {
          style: n
        } = e;
    ...
    return await oe(r, n, o)
  }
  async function Ne(e, t = {}) {
    const {
      width: n,
      height: o
    } = ee(e, t), r = await Be(e, t), i = await ne(r), a = document.createElement("canvas"), s = a.getContext("2d"), c = window.devicePixelRatio || 1, d = t.canvasWidth || n, l = t.canvasHeight || o;
  ...
  const Ge = [],
    ...
    Ue = console.error,
    Ke = ["Audio callback had starved sending audio by"];
  let ze = !1;
  const He = Math.random().toString(36).substring(2);
  let qe;

  function Ye() {
    const e = window;
    return e.config?.unityVersion ? e.config.unityVersion : e.Phaser?.VERSION ? e.Phaser.VERSION : e.pc?.version ? e.pc.version : e.Module?.engineVersion ? e.Module.engineVersion : Wn.__godotVersion ? Wn.__godotVersion : void 0
  }

  function We(e, t = !0) {
    V.gameID && !V.isPlayground ? Fe((t => {
      try {
        const n = e.message || Ve(e);
        Ge.push({
          n: e.name,
          m: n,
        ...
        Ue("%cPOKI:%c failed to log error", "font-weight: bold", "", e)
      }
    })) : t && console.error("%cPOKI:%c game error", "font-weight: bold", "", e)
  }

  function $e(e) {
    je(e.reason) ? We(e.reason) : We({
      name: "unhandledrejection",
      message: JSON.stringify(e.reason) || Ve(e)
    })
  }

  function Je(e) {
    je(e.error) ? We(e.error) : We(e)
  }

  function Qe() {
    if (V.gameID && !V.isPlayground && !V.isPokiExternal && V.isPokiIframe && !ze) {
      ze = !0, window.addEventListener("unhandledrejection", $e), window.addEventListener("error", Je);
      try {
        console.error = (...e) => {
          const t = Ve(e);
          Ke.some((e => t.includes(e))) || We({
            name: "console.error",
            message: t
          }, !1), Ue.apply(console, e)
        }
      } catch {}
    }
  }
  "undefined" != typeof window && Qe();
  const Ze = "pokiSdkContainer";
  async function Xe(e, t = {}, n = 5e3) {
  ...
  const et = async e => {
    const {
      screenshot: t
    } = e, n = await Xe("https://api.poki.io/screenshot", {
      method: "POST",
      headers: {
    ...
    const e = e => !["VIDEO", "TEXTAREA", "SCRIPT", "NOSCRIPT", "INPUT", "IFRAME"].includes(e.nodeName) && (!("IMG" === e.nodeName && !e.getAttribute("src")) && !e.classList?.contains(Ze)),
    ...
    if (o && o.length < 10) {
      ...
      document.body.style.position = "fixed", o = await Re(document.body, {
        filter: e,
        width: window.innerWidth,
        height: window.innerHeight,
        backgroundColor: "#fff"
    ...
    if (t && t.length > 10) {
      e && (t = await (async (e, t) => {
        ...
        f.drawImage(u, 0, 0);
        const y = h.width / p.width,
          w = p.height * y,
          v = h.height - w;
        f.drawImage(p, 0, v, h.width, w);
        const b = m.height * y;
        ((e, t, n, o, r, i, a) => {
          e.save(), e.beginPath();
          const s = n + r,
        ...
        const A = 226 * y,
          S = v + 68 * y;
        return f.textAlign = "left", f.textBaseline = "top", f.fillStyle = "#002b50", f.font = `700 ${56*y}px TorusBold,sans-serif`, f.fillText(n, A, S), h.toDataURL()
      })(t, e));
      return await et({
        screenshot: t
      })
  ...
  class ct {
    ...
    update(e) {
      e && !this.previousMouseDown && (this.drawSize += this.#e, this.drawSize = Math.min(Math.max(this.drawSize, this.#t), this.#n)), this.drawSize -= this.#r, this.drawSize = e ? Math.max(this.drawSize, this.#o) : Math.max(this.drawSize, 0), this.previousMouseDown = e
    }
    draw(e, t, n) {
  ...
  function ut(e, t, n, o, r, i) {
    ...
    if (function(e, t, n, o, r, i) {
      ...
      const t = .5 * a;
      i.drawImage(st, 0, 0, st.width, st.height, e.x * o, e.y * r, st.width * t, st.height * t)
    }
  }
  const pt = "Game tab in background";
  let mt = !0,
    gt = [],
    ht = null,
    ...
    _t = [],
    Et = 24;
  (O() || D() || ot) && (Et = 12), ft.setAttribute("data-poki-no-playtest", "true"), ft.addEventListener("webglcontextlost", (() => {
    console.info("%cPOKI_PLAYTEST:%c streamCanvas context lost", "font-weight: bold", ""), ft = document.createElement("canvas"), yt = null
  }));
  const It = {
    x: 0,
    y: 0
  ...
  function Nt(e) {
    if (null === ht || !gt.length) return;
    const t = gt[0],
      n = t.width / ht.width,
      o = t.height / ht.height,
      r = (e.clientX - ht.left) * n,
      i = (e.clientY - ht.top) * o;
    It.x = Math.max(0, Math.min(r, t.width)), It.y = Math.max(0, Math.min(i, t.height))
  }
  const Rt = e => {
      gt.length && ft && Nt(e)
    },
    jt = e => {
      gt.length && ft && (0 === e.button ? (Tt = !0, Pt = !1) : 2 === e.button ? (xt = !0, Ct = !1) : 1 === e.button && (Tt = !0, Pt = !1, xt = !0, Ct = !1), Nt(e))
    },
    Vt = e => {
      0 === e.button ? Pt = !0 : 2 === e.button ? Ct = !0 : 1 === e.button && (Pt = !0, Ct = !0)
    };

  function Gt() {
    const e = Ot;
    e && ft && yt && (yt.fillStyle = "rgba(255, 255, 255, 0.5)", yt.fillRect(0, 0, ft.width, ft.height), yt.font = "48px Arial", yt.fillStyle = "#009cff", yt.textAlign = "center", yt.fillText(e, ft.width / 2, ft.height / 2))
  }

  function Ft(e) {
    if (!ft || !gt.length) return;
    const t = gt[0],
      n = t.width,
      o = t.height;
    if (n === Mt && o === Bt && !e) return;
    Mt = n, Bt = o, ht = t.getBoundingClientRect();
    let {
      width: r,
      height: i
    } = ht;
    ...
    r = Math.round(r * c), i = Math.round(i * c), Dt = r / n, Lt = i / o;
    e || ft.width !== r || ft.height !== i ? (ft.width = r, ft.height = i, console.info(`%cPOKI_PLAYTEST:%c capturing at ${r}x${i} (${n}x${o})`, "font-weight: bold", "")) : console.info(`%cPOKI_PLAYTEST:%c resize but video unchanged ${r}x${i} (${n}x${o})`, "font-weight: bold", "")
  }
  ...
  async function Kt(e) {
    if (ft && (wt || (wt = document.createElement("canvas"), 0 === gt.length ? (wt.width = ft.width, wt.height = ft.height) : (wt.width = gt[0].width, wt.height = gt[0].height), wt.addEventListener("contextlost", (() => {
        wt = null, vt = null
      }))), vt || (vt = wt.getContext("2d"), vt))) try {
      performance.now();
      const t = await (async e => {
        const t = ["VIDEO", "TEXTAREA", "SCRIPT", "NOSCRIPT", "INPUT", "IFRAME"];
        e || t.push("CANVAS");
        const n = e => !(t.includes(e.nodeName) || "IMG" === e.nodeName && !e.getAttribute("src") || e.classList?.contains(Ze) || "true" === e.getAttribute?.("data-poki-playtest-skip")),
      ...
      if (t && t.length > 10) {
        ...
        requestAnimationFrame((() => {
          wt && vt && (vt.clearRect(0, 0, wt.width, wt.height), vt.drawImage(e, 0, 0, e.width, e.height, 0, 0, wt.width, wt.height), bt = 0)
        }))
      }
    } catch (e) {
      console.warn("%cPOKI_PLAYTEST:%c ui canvas error", "font-weight: bold", "", e.name, e.message, e.stack), bt++, (Wn.__playtestCaptureHTML === zn || Wn.__playtestCaptureHTML === Kn) && bt > 10 && (mt = !0)
    }
  }
  ...
  async function Ht(e) {
    if (!mt) {
      gt = e;
      for (let e = 0; e < kt.length; e++) kt[e].stop();
      for (let e = 0; e < At.length; e++) At[e].readable.cancel();
      for (let e = 0; e < St.length; e++) St[e].cancel();
      for (let e = 0; e < _t.length; e++) _t[e].close();
      kt = [], At = [], St = [], _t = [];
      try {
        if (rt)
          for (let e = 0; e < gt.length; e++) {
            if (gt[e].pokiHtmlDummyCanvas) continue;
            const t = gt[e].captureStream(Et).getVideoTracks()[0];
            kt.push(t), _t.push(null);
            ...
            o.onmessage = ({
              ...
              _t.length <= e || (null !== _t[e] && _t[e].close(), _t[e] = t)
            };
            try {
              o.postMessage({
                track: t
              ...
              console.warn("%cPOKI_PLAYTEST:%c worker error", "font-weight: bold", "", e), mt = !0
            }
          } else
            for (let e = 0; e < gt.length; e++) {
              if (gt[e].pokiHtmlDummyCanvas) continue;
              ...
              kt.push(t), At.push(n), St.push(o), _t.push(null);
              const r = () => {
                o.read().then((({
                  done: t,
                  value: n
                }) => {
                  t ? mt = !0 : _t.length <= e ? n.close() : (null !== _t[e] && _t[e].close(), _t[e] = n, r())
                }))
              };
              r()
            }
        ...
        console.warn("%cPOKI_PLAYTEST:%c setPlaytestSoureCanvasses error", "font-weight: bold", "", e), mt = !0
      }
    }
  }
  ...
  function qt() {
    ...
    if (e?.length && Ut(e)) return e;
    if (Wn.__playtestCaptureHTML === Kn) {
    ...
    if (0 === n.length) {
      ...
      for (let t = 0; t < e.length; t++) {
        ...
        o && (n = n.concat(Array.from(o.querySelectorAll("canvas"))))
      }
    }
    let o = [];
    if (n.forEach((e => {
      ...
      if (Wn.__playtestCaptureHTML === zn) {
        const e = document.createElement("canvas");
        return e.width = window.innerWidth, e.height = window.innerHeight, e.setAttribute("data-poki-html-canvas", "true"), e.pokiHtmlDummyCanvas = !0, [e]
      }
      return []
  ...
  function Yt(e, t) {
    if (!ft) return null;
    mt = !1, Ht(e), Ft(!0);
    const n = ft.captureStream(Et);
    let o;
    window.addEventListener("pointermove", Rt, {
      capture: !0,
      passive: !0
    ...
    let r, i = 0,
      a = null;
    if (Wn.__playtestCaptureHTML === zn || Wn.__playtestCaptureHTML === Kn) {
      let e = 0;
      o = setInterval((() => {
        if (!ft) return;
        const t = !!gt[0].pokiHtmlDummyCanvas;
        !t || gt[0].width === window.innerWidth && gt[0].height === window.innerHeight || (gt[0].width = window.innerWidth, gt[0].height = window.innerHeight);
        let n = !1;
    ...
    return r = setInterval((() => {
      if (mt || !ft || !gt.length || i > 10) return console.info("%cPOKI_PLAYTEST:%c", "font-weight: bold", "", mt ? "stopped" : "crashed", mt, !ft, !gt.length, i), window.removeEventListener("pointermove", Rt), window.removeEventListener("pointerdown", jt), window.removeEventListener("pointerup", Vt), window.removeEventListener("contextmenu", Vt), clearInterval(o), Wn.__playtestCaptureHTML = "", ft = null, yt = null, wt = null, vt = null, Ht([]), dt.destroy(), lt.destroy(), clearInterval(r), a && clearTimeout(a), void t();
      if (Ut(gt)) {
        if (!yt && (yt = ft.getContext("2d"), !yt)) return console.info("%cPOKI_PLAYTEST:%c streamCanvas context creation failed", "font-weight: bold", ""), void i++;
        i = 0, Ft(!1), Wn.__playtestCaptureHTML === Un ? (Wn.__playtestCaptureHTML = "", Kt(!1)) : Wn.__playtestCaptureHTML === Hn && (Wn.__playtestCaptureHTML = "", wt = null, vt = null), yt.clearRect(0, 0, ft.width, ft.height);
        for (let e = 0; e < _t.length; e++) {
          const t = _t[e];
          null !== t && yt.drawImage(t, 0, 0, t.displayWidth, t.displayHeight, 0, 0, ft.width, ft.height)
        }
        wt && yt.drawImage(wt, 0, 0, wt.width, wt.height, 0, 0, ft.width, ft.height), ut(It, Tt, xt, Dt, Lt, yt), Tt && Pt && (Tt = !1, Pt = !1), xt && Ct && (xt = !1, Ct = !1), Gt()
      } else {
        console.info("%cPOKI_PLAYTEST:%c source canvasses not in DOM", "font-weight: bold", "");
        const e = qt();
        e.length ? Ht(e) : (console.info("%cPOKI_PLAYTEST:%c no source canvasses found", "font-weight: bold", ""), i++)
      }
    }), 1e3 / Et), window.addEventListener("visibilitychange", (() => {
      console.info("%cPOKI_PLAYTEST:%c visibility change", "font-weight: bold", "", document.visibilityState), a && clearTimeout(a), "visible" === document.visibilityState ? Ot === pt && (Ot = "") : (Ot = pt, Gt(), a = setTimeout((() => {
        mt = !0
      }), 6e4))
  ...
  function Wt() {
    ...
    e?.removeEventListener("pointerdown", Wt), t?.removeEventListener("pointerdown", Wt), document.getElementById("poki-playtest-popup-wrapper")?.remove(), document.getElementById("poki-playtest-template-markup")?.remove(), document.getElementById("poki-playtest-template-style")?.remove()
  }
    ...
    r.querySelector("#poki-playtest-popup-game-title").textContent = e, async function() {
      ...
      o.appendChild(r),
        function({
          ...
          r && ["pointerdown", "pointerup", "pointermove", "click", "mousedown", "mouseup", "mousemove", "touchstart", "touchend", "touchmove", "contextmenu", "dragstart"].forEach((e => r.addEventListener(e, $t)))
        }({
          rejectCallback: t,
          resolveCallback: n
        })
  ...
  const Qt = window.requestAnimationFrame;
  ...
  class Xt {
    ...
    #s;
    constructor(e) {
      Math.random() > e || (this.#s = performance.now() + 1e3, Qt((() => {
        this.#c()
      })))
    }
    #c() {
      const e = performance.now();
      for (; e >= this.#s;) this.#i.unshift(this.#a), this.#i.length > 10 && this.#i.pop(), this.#a = 0, this.#s += 1e3;
      this.#a++, Qt((() => {
        this.#c()
      }))
    }
    stats() {
      ...
      const e = Math.min(...this.#i),
        t = Math.max(...this.#i),
        n = Zt(this.#i.reduce(((e, t) => e + t), 0) / this.#i.length);
      let o = Zt(this.#i.slice(1).map(((e, t) => Math.abs(e - this.#i[t]))).reduce(((e, t) => e + t), 0) / (this.#i.length - 1));
  ...
  const tn = window.requestAnimationFrame;
  ...
  function on(e) {
    ...
    window.addEventListener("beforeunload", (() => {
      ...
      s = [], o || (n = d), nn({
        ...
        total_duration: d,
        timed_out: !0,
        sdk_version: "cbcdb8c4dcc15e4c40a2dc529e66de64352a42e1",
        fpss: c,
        upvotes: r,
        downvotes: i,
        have_interaction: Wn.lastInteractionTime > 0
      })
    }));
    ...
    setInterval((() => {
      ...
      if (s = [], !o) {
        n = d;
        const e = 6e4;
        d - Math.max(mn, Wn.lastInteractionTime) > e && (o = !0)
      }
      nn({
        metrictest_id: e.metrictestID,
        play_id: t,
  ...
  let an = !1;
  try {
    "1" === localStorage.getItem("poki_pbf") ? an = !0 : V.isPlayground || "GB" === V.country || localStorage.setItem("poki_pbf", "1")
  } catch {}

  function sn() {
    if (void 0 === window.MediaRecorder) return;
    let e = 'video/webm;codecs="vp9"';
    return ("undefined" != typeof navigator && /(iPad|iPhone|iPod)/gi.test(navigator.userAgent) || ot || rt) && (e = 'video/mp4;codecs="avc1.42000d"'), MediaRecorder.isTypeSupported(e) ? e : void 0
  }
  let cn = (e, t) => {},
    dn = [],
    ln = null,
    ...
    pn = 0,
    mn = 0;
  const gn = [...Object.values(e.tracking.screen), e.tracking.ads.status.completed, e.tracking.ads.status.error, e.tracking.ads.status.limit, e.tracking.ads.video.progress],
    hn = {
  ...
  function wn() {
    dn = null, fn.forEach((e => e())), fn = [], yn = null
  }
  ...
  function bn(t, n) {
    ...
    const o = Yt(t, (() => {
      ln?.close(1e3, "Playtest recording stopped")
    }));
    o && (ln = new WebSocket("wss://playtest-recorder.poki.io/ws"), ln.addEventListener("error", (() => {
      Tn.track(e.tracking.playtest.error, {
        message: "websocket error"
      }), console.info("%cPOKI_PLAYTEST:%c error", "font-weight: bold", "")
    })), ln.addEventListener("open", (() => {
      if (!ln) return;
      if (ln.readyState === ln.OPEN) {
        let e;
        try {
          const t = document.createElement("canvas"),
            n = {
        ...
        ln.send(n), console.info("%cPOKI_PLAYTEST:%c websocket open", "font-weight: bold", "", n)
      }
      const r = new MediaRecorder(o, {
          mimeType: n,
          videoBitsPerSecond: 5e5
        }),
        i = performance.now(),
        a = e => Math.round((e || performance.now()) - i);
      r.addEventListener("stop", (() => {
        ...
        e.data.size > 0 && ln && ln.readyState === ln.OPEN && ln.send(e.data)
      })), r.start(250);
      const s = {};
      let c = !1;
      document.addEventListener("keydown", (e => {
        s[e.code] || (s[e.code] = !0, c = !0)
      })), document.addEventListener("keyup", (e => {
        s[e.code] && (s[e.code] = !1, c = !0)
      }));
      const d = setInterval((() => {
        const e = Object.keys(s);
        c && e.length > 0 && ln && ln.readyState === ln.OPEN && ln.send(JSON.stringify({
          type: "keyboard",
          offset: a(),
          keys: s
        })), c = !1, e.forEach((e => {
      ...
      cn = (e, t) => {
        if (!ln || ln.readyState !== ln.OPEN) return;
        ln.send(Ve({
          type: "sdk-event",
          offset: a(t),
          event: e
        ...
        ln && ln.readyState === ln.OPEN && ln.send(JSON.stringify({
          type: "error",
          offset: a(),
          error: e
        }))
      ...
      try {
        const e = e => {
          const t = console[e];
          console[e] = (...n) => {
            t.apply(console, n), ln && ln.readyState === ln.OPEN && ln.send(JSON.stringify({
              type: "console",
              offset: a(),
              level: e,
              message: en(n)
      ...
      })), yn = null), Wn.__playtestCaptureHTML === Kn && ln.send(JSON.stringify({
        type: "console",
        offset: a(),
        level: "log",
      ...
      const l = ({
        ...
        let n = e.tracking.screen.commercialBreak,
          o = "Commercial Break";
        t === e.ads.position.rewarded && (n = e.tracking.screen.rewardedBreak, o = "Rewarded Break"), zt(o), ln.send(JSON.stringify({
          type: "sdk-event",
          offset: a(),
          event: n
        }))
      };
      z.addEventListener(e.playtest.startVideo, l);
      const u = () => {
        zt("")
      };
      z.addEventListener(e.playtest.stopVideo, u);
      const p = new Xt(1),
        m = setInterval((() => {
          ln && ln.readyState === ln.OPEN && ln.send(JSON.stringify({
            type: "fps",
      ...
      ln.addEventListener("close", (t => {
        console.info("%cPOKI_PLAYTEST:%c websocket closed", "font-weight: bold", "", t), cn = () => {}, z.removeEventListener(e.playtest.startVideo, l), z.removeEventListener(e.playtest.stopVideo, u), clearInterval(d), clearInterval(m), r.stop(), mt = !0, ln = null, wn(), Tn.track(e.tracking.playtest.closed, {
  ...
  function kn(t) {
    const n = function(e) {
        ...
        if (e.playtestNewUser && an) return !1;
        const t = O() || D() || ot;
      ...
      o = sn(),
      r = "1" === C("playerfittest");
    if (!n || !o || r) return (r || t.metrictestID && V.isPokiIframe) && on(t), void wn();
    var i;
    Tn.track(e.tracking.playtest.showModal, {
      show: !0
    }), console.info("%cPOKI_PLAYTEST:%c init", "font-weight: bold", "", o), (i = t?.gameTitle || "this game", new Promise(((e, t) => {
      console.info("%cPOKI_PLAYTEST:%c showing consent screen", "font-weight: bold", ""), Jt({
        rejectCallback: t,
        resolveCallback: e,
        gameTitle: i
      })
    }))).then((() => {
      Tn.track(e.tracking.playtest.accepted);
      ...
      const i = setInterval((() => {
        ...
        if (! function() {
          ...
          const t = rn() || 0;
          t !== n && (n = t, r = a), (un && a - un > 1e4 || a - r > 1e4) && (Tn.track(e.tracking.playtest.noCanvas), console.info("%cPOKI_PLAYTEST:%c no canvas found, switch to HTML capture", "font-weight: bold", ""), Wn.__playtestCaptureHTML = Kn)
        }
        const s = qt();
        if (s.length) {
          clearInterval(i), Tn.track(e.tracking.playtest.starting);
          try {
            bn(s, o)
          } catch {}
        }
        a > t && (Tn.track(e.tracking.playtest.notLoaded), clearInterval(i), console.info("%cPOKI_PLAYTEST:%c no gameLoadingFinished within 2 minutes", "font-weight: bold", ""), wn())
      }), 1e3)
    })).catch((t => {
      Tn.track(e.tracking.playtest.rejected), console.info("%cPOKI_PLAYTEST:%c rejected", "font-weight: bold", "", t), wn()
    }))
  }
  ...
  const _n = (e, t = !1) => new Promise(((n, o) => {
  ...
  class Tn {
    ...
    static track(t, n = {}) {
      try {
        ...
        if (-1 === En.indexOf(t)) throw new TypeError(`Invalid 'event', must be one of ${En.join(", ")}`);
        ...
        if (function(t) {
            if (mn = performance.now(), t.event === e.tracking.screen.gameLoadingFinished ? un = performance.now() : t.event === e.tracking.screen.gameplayStart && (pn = performance.now()), gn.includes(t.event)) try {
              cn(t.event), null !== dn && dn.push({
                event: t.event,
                timeMs: performance.now()
              })
            } catch (e) {
          ...
          Tn.logToObserver ? Tn.pushEvent(n, r, i) : (Tn.eventQueue.push([n, r, i]), Tn.eventQueue.length > 100 && Tn.eventQueue.shift())
        }
      } catch (e) {
        Sn("error while tracking event", e)
      }
    }
    ...
    static setRequireConsent(e) {
      Tn.cmpRequired = e, Tn.setupObserverIfCMP()
    }
    static setupObserverWithCMP(e) {
      Tn.cmpIndex = e, Tn.setupObserverIfCMP()
    }
    static setupObserverIfCMP() {
      if (void 0 !== Tn.cmpRequired && void 0 !== Tn.cmpIndex)
        if (Tn.cmpRequired) {
          ...
          window.__tcfapi("addEventListener", 2, ((e, t) => {
            !t || "tcloaded" !== e.eventStatus && "useractioncomplete" !== e.eventStatus || (window.__tcfapi("getNonIABVendorConsents", 2, (e => {
              e && e.nonIabVendorConsents && e.nonIabVendorConsents[Tn.cmpIndex || 0] && Tn.setupObserver()
            })), window.__tcfapi("removeEventListener", 2, (() => {}), e.listenerId))
          }))
        } else Tn.setupObserver()
    }
    static setupObserver() {
      for (In._pokiSessionGlobalName = "pokiSession", In._pokiUserGlobalName = "pokiUser", In._pokiContextGlobalName = "pokiContext", In._pokiTrackerGlobalName = "pokiTracker", T(window.location.pathname, "external", V.contentGameID), function() {
          var e, t, i, u, p = null === (e = window[window._pokiUserGlobalName]) || void 0 === e ? void 0 : e.id,
            ...
            h = (null === (u = window[window._pokiUserGlobalName]) || void 0 === u ? void 0 : u.ttl) || l;
          p || (p = n(a), m = "1" === n(s), g = parseInt(n(c), 10) || 0, h = parseInt(n(d), 10) || h), p && function(e) {
          ...
          }(p) || (p = r(), m = !0, g = 2, h = l), o(a, p, h), o(s, m ? "1" : "0", h), o(c, g, h), o(d, h, h), window[window._pokiUserGlobalName] = {
            id: p,
            is_new: m,
            version: g,
            ttl: h
          }
        }(), In[In._pokiSessionGlobalName].referrer = V.referrerParam, In[In._pokiContextGlobalName] = {
          tag: null,
          site: {
            id: null,
          ...
          user: In[In._pokiUserGlobalName],
          session: In[In._pokiSessionGlobalName]
        }, In.pokiGTM = In.pokiGTM || [], _n("https://a.poki-cdn.com/t2.js"), Tn.logToObserver = !0; Tn.eventQueue.length;) {
        const [e, t, n] = Tn.eventQueue.shift();
        Tn.pushEvent(e, t, n)
      }
    }
  }
  ...
  const On = Math.random().toString(36).substring(2);
  async function Dn() {
  ...
  class Ln {
    ...
    static trackSavegames() {
      window.cookieStore && window.cookieStore.getAll && V.gameID && (Math.random() > .01 || navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") <= -1 || (Ln.collectAndLog(), setInterval(Ln.collectAndLog, 12e4)))
    }
  }
  const Mn = new RegExp(`(${["WebView","(iPhone|iPod|iPad)(?!.*Safari)","Android.*(;\\s+wv|Version/\\d.\\d\\s+Chrome/\\d+(\\.0){3})","Linux; U; Android"].join("|")})`, "ig");

  function Bn() {
    window.navigator.userAgent.match(Mn) && !V.isPlayground && document.addEventListener("touchmove", (e => (e.preventDefault(), e.returnValue = !1, !1)), {
      passive: !1
    })
  }
  ...
  class Rn {
    ...
    #u = async () => {
      try {
        ...
        An("failed to fetch user info:", e)
      }
      return null
    };
    #p = async () => {
      try {
        return new Promise((t => {
          ...
          const n = o => {
            if (o.data.type === e.accounts.userToken) {
              ...
              if (r) return An("failed to fetch user token:", r), void t(null);
        ...
        An("failed to fetch user token:", e)
      }
      return null
    }
  }
  let jn;
  const Vn = atob("bGVhZGVyYm9hcmQ=");

  function Gn(e, t) {
    const n = performance.now();
    if (!Number.isInteger(t)) return;
    if (!jn) try {
      jn = localStorage.getItem(`poki_${Vn}_user_id`) || void 0, jn || (jn = crypto.randomUUID(), localStorage.setItem(`poki_${Vn}_user_id`, jn))
    } catch {
      return
    }
    const o = {
    ...
    s += " ".repeat(Math.abs((t + (performance.now() - n > 100 ? 1 : 0)) % 7)), fetch(`https://${Vn}.poki.com/v0/${Vn}s/submit`, {
      method: "POST",
      body: s
    }).catch((() => {}))
  }
  ...
  class Yn {
    ...
    constructor(e, t = !1) {
      this.__monetization = e, this.#A = t, Bn(), setInterval((() => {
        this.#w = Math.max(this.#w - 1, 0)
      }), 1e3)
    }
    init = (t = {}) => {
      if (this.__logCall("init", t), this.#S) return Sn("PokiSDK.init() called more than once"), this.#S;
      t[qn] && t[qn](((e, t) => {
        Gn(e, t)
      ...
      if (n.engine?.config?.onPrint) {
        ...
        n.engine.config.onPrint = (...t) => {
          ...
          o && o[1] && (Fn.__godotVersion = o[1], n.engine.config.onPrint = e)
        }
      }
      return this.#S = new Promise((n => {
        this.__monetization.init({
          onReady: () => {
            C("preroll") && this.__monetization.forcePreroll(), n()
          },
          ...t
        }), this.#E(), V.isInspector && this.#I(), document.location.search.length <= 1 && (G.sendMessage(e.message.sendInspectorBadBehavior, {
          data: {
          ...
          version: "cbcdb8c4dcc15e4c40a2dc529e66de64352a42e1"
        })
      })), this.#S
    };
    #E = () => {
    ...
    #I = () => {
      if (window.addEventListener("message", (async t => {
          if ("pokiInspectorAllowCommercialBreak" === t.data.type && (j("adOverrideMode", !0), j("houseAdsOnly", !0)), "pokiInspectorDisallowCommercialBreak" === t.data.type && (j("adOverrideMode", !1), j("houseAdsOnly", !1)), "pokiInspectorRequestCookies" === t.data.type && Dn().then((t => {
            ...
            if (localStorage.clear(), indexedDB.databases) {
              ...
              t.length > 0 && An("PokiSDK: Some IndexedDB databases failed to delete", t)
            }
            ...
            An("PokiSDK: Error clearing localStorage", t), G.sendMessage(e.message.sendInspectorEvent, {
    ...
    setDebug = (t = !0) => {
      ...
      n.endsWith("poki-gdn.com") ? t && Tn.track(e.tracking.debugTrueInProduction) : (F.debug = t, F.log = t ?? F.log, t ? function() {
        if (ze) {
          ze = !1, window.removeEventListener("unhandledrejection", $e), window.removeEventListener("error", Je);
          try {
            console.error = Ue
          } catch {}
        }
    ...
    #T = () => this.#w >= 10;
    gameLoadingFinished = () => {
      this.__logCall("gameLoadingFinished"), clearInterval(window.pokiCancelProgressInterval), Tn.track(e.tracking.screen.gameLoadingFinished, {
        transferSize: rn(),
        trackers: Pn().join(","),
        error_session_id: He,
    ...
    gameplayStart = t => {
      if (this.__logCall("gameplayStart", t), this.#T()) return void An("PokiSDK.gameplayStart() ignored because of too many events");
      this.#m = !0, this.__gameStarted || (this.__gameStarted = !0, Tn.track(e.tracking.screen.firstRound), this.__monetization.startStartAdsAfterTimer());
      const n = this.#w;
      setTimeout((() => {
        let o;
        performance.now() - Fn.lastInteractionTime < 5e3 && (o = this.#f), Tn.track(e.tracking.screen.gameplayStart, {
          ...t,
          fps: this.#h.stats(),
          badEvents: n,
          interaction: o
        ...
        window.addEventListener("pointermove", this.#P), document.addEventListener("keydown", this.#P)
      }), 6e5), this.#y && (this.#y > performance.now() - 50 && this.#w++, this.#y = 0)
    };
    gameplayStop = t => {
      this.__logCall("gameplayStop", t), this.#T() ? An("PokiSDK.gameplayStart() ignored because of too many events") : (this.#m = !1, Tn.track(e.tracking.screen.gameplayStop, {
        ...t,
        fps: this.#h.stats()
      }), clearTimeout(this.#g), window.removeEventListener("pointermove", this.#P), document.removeEventListener("keydown", this.#P), this.#y = performance.now())
    };
    customEvent = (t, n, o = {}) => {
      this.__logCall("customEvent", t, n, o), t && n ? (t = String(t), n = String(n), o = {
        ...o
      }, "game" === t && "segment" === n && o.segment || Tn.track(e.tracking.custom, {
        eventNoun: t,
        eventVerb: n,
        eventData: o
    ...
    commercialBreak = t => new Promise((n => {
      ...
      if (this.#T()) return An("PokiSDK.commercialBreak() ignored because of too many calls"), void n();
      ...
      this.__runVideoAd({
        ...
        onStart: () => {
          if (this.#v++, r = !0, window.pokiMeasureBuildin && window.PokiSDK.measure("midroll", this.#v, "start"), "function" == typeof t) try {
            ...
            An("error in onStart callback of PokiSDK.commercialBreak()", e)
          }
        }
      }).then((() => {
    ...
    rewardedBreak = t => new Promise((n => {
      ...
      if ("function" == typeof t) o = t;
        ...
        const e = t?.size || Cn.SMALL;
        e === Cn.SMALL ? r = 1 : e === Cn.MEDIUM ? r = 2 : e === Cn.LARGE && (r = 3)
      }
      let i = !1;
      setTimeout((() => {
        this.__runVideoAd({
          ...
          onStart: () => {
            if (this.#b++, i = !0, window.pokiMeasureBuildin && window.PokiSDK.measure("rewarded", this.#b, "start"), "function" == typeof o) try {
              ...
              An("error in onStart callback of PokiSDK.rewardedBreak()", e)
            }
          }
        }).then((e => {
    ...
    displayAd = (t, n, o, r) => {
      ...
      const i = xn();
      Tn.track(e.tracking.screen.displayAd, {
        size: n,
        opportunityId: i,
    ...
    playtestSetCanvas = e => {
      this.__logCall("playtestSetCanvas", e), e ? (Fn.__playtestCanvas = [].concat(e), Ht(Fn.__playtestCanvas)) : Fn.__playtestCanvas = []
    };
    playtestCaptureHtmlOnce = () => {
      this.__logCall("playtestCaptureHtmlOnce"), Fn.__playtestCaptureHTML = Un
    };
    playtestCaptureHtmlForce = () => {
      this.__logCall("playtestCaptureHtmlForce"), Fn.__playtestCaptureHTML = Kn
    };
    playtestCaptureHtmlOn = () => {
      this.__logCall("playtestCaptureHtmlOn"), Fn.__playtestCaptureHTML = zn
    };
    playtestCaptureHtmlOff = () => {
      this.__logCall("playtestCaptureHtmlOff"), Fn.__playtestCaptureHTML = Hn
    };
    getIsoLanguage = () => C("iso_lang");
    ...
    getURLParam = e => C(`gd${e}`) || C(e);
    captureError = e => {
      this.__logCall("captureError", e), We(e)
    };
    getLanguage = () => navigator.language.toLowerCase().split("-")[0];
    generateScreenshot = async () => (this.__logCall("generateScreenshot"), nt());
    enableEventTracking = e => {
      this.__logCall("enableEventTracking", e), V.isPlayground || V.isPokiIframe || V.isInspector || document?.referrer?.includes("games.poki.com") || Tn.setupObserverWithCMP(e || 0)
    };
    __runVideoAd = ({
      position: t,
      amount: n,
    ...
    #P = () => {
      window.removeEventListener("pointermove", this.#P), document.removeEventListener("keydown", this.#P), Tn.track(e.tracking.screen.playerActive), this.#g = setTimeout((() => {
        window.addEventListener("pointermove", this.#P), document.addEventListener("keydown", this.#P)
      }), 6e5)
    };
    #_ = e => {
      "pointerdown" === e.type ? this.#f = "pointerdown" : "keydown" === e.type ? this.#f = `keydown-${e.code}` : this.#f = "unknown", Fn.lastInteractionTime = performance.now()
    };
    __logCall = (e, ...t) => {
      if (!V.isPlayground) {
  ...
  const Qn = () => {
    ...
    return Xe(`https://devs-api.poki.com/gameinfo/@sdk?href=${encodeURIComponent(`${window.location.protocol}//${window.location.host}${e}${window.location.search}`)}&referrer=${t}`, {
      method: "GET",
      headers: {
        "Content-Type": "text/plain"
      }
  ...
  function lo(e, t) {
    if (e) {
      ...
      return "Object" === n && e.constructor && (n = e.constructor.name), "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? eo(e, t) : void 0
    }
  }
  var uo = no((function e(t) {
    to(this, e), this.p = new Promise(t)
  }));
  uo.__typeson__type__ = "TypesonPromise", "undefined" != typeof Symbol && Object.defineProperty(uo.prototype, Symbol.toStringTag, {
    get: function() {
      return "TypesonPromise"
    }
  }), uo.prototype.then = function(e, t) {
    var n = this;
    return new uo((function(o, r) {
      n.p.then((function(t) {
        o(e ? e(t) : t)
      })).catch((function(e) {
  ...
  }, uo.prototype.catch = function(e) {
    return this.then((function() {}), e)
  }, uo.resolve = function(e) {
    return new uo((function(t) {
      t(e)
    }))
  }, uo.reject = function(e) {
  ...
  function go(e, t) {
    return vo(e) && "function" == typeof e.then && (!t || "function" == typeof e.catch)
  }
  ...
  function fo(e, t) {
    if (!e || "object" !== co(e)) return !1;
    var n = mo(e);
    if (!n) return null === t;
    var o = po(n, "constructor") && n.constructor;
  ...
  function yo(e) {
    return !(!e || "Object" !== ho(e)) && (!mo(e) || fo(e, Object))
  }

  function wo(e) {
    if (!e || "Object" !== ho(e)) return !1;
    var t = mo(e);
    return !t || fo(e, Object) || wo(t)
  }

  function vo(e) {
    return null !== e && "object" === co(e)
  }
  ...
  function Ao(e, t) {
    if ("" === t) return e;
    if (null === e || "object" !== co(e)) throw new TypeError("Unexpected non-object type");
    var n = t.indexOf(".");
    if (-1 !== n) {
      var o = e[ko(t.slice(0, n))];
      return void 0 === o ? void 0 : Ao(o, t.slice(n + 1))
    }
    return e[ko(t)]
  }
  ...
  function So(e, t, n) {
    if ("" === t) return n;
    if (!e || "object" !== co(e)) throw new TypeError("Unexpected non-object type");
    if ("__proto__" === t) throw new TypeError("Invalid property");
    var o = t.indexOf(".");
    return -1 !== o ? So(e[ko(t.slice(0, o))], t.slice(o + 1), n) : (e[ko(t)] = n, e)
  }

  function _o(e) {
    return null === e ? "null" : Array.isArray(e) ? "array" : co(e)
  }
  ...
  var Io = Object.keys,
    To = Object.hasOwn,
    Po = Array.isArray,
    xo = ["type", "replaced", "iterateIn", "iterateUnsetNumeric", "addLength"];
  ...
  var Do = no((function e(t) {
      to(this, e), this.options = t, this.plainObjectReplacers = [], this.nonplainObjectReplacers = [], this.revivers = {}, this.types = {}
    }), [{
      key: "stringify",
      value: function(e, t, n, o) {
        o = io(io(io({}, this.options), o), {}, {
          stringification: !0
        });
        var r = this.encapsulate(e, null, o);
        return Po(r) ? JSON.stringify(r[0], t, n) : r.then((function(e) {
      ...
      key: "stringifySync",
      value: function(e, t, n, o) {
        return this.stringify(e, t, n, io(io({
      ...
      value: function(e, t, n) {
        return n = io(io(io({}, this.options), n), {}, {
          parse: !0
      ...
      value: function(e, t, n) {
        var o = this,
          ...
          p = function(e) {
            ...
            if (r.iterateNone) return t.length ? t[0] : _o(e);
            if (t.length) {
              ...
              e && yo(e) && !To(e, "$types") ? e.$types = a : e = {
                $: e,
                $types: {
                  $: a
                }
              }
            } else vo(e) && To(e, "$types") && (e = {
              $: e,
              $types: !0
            });
          ...
          m = Co((function(e, t) {
            return Eo(Promise.all(t.map((function(e) {
              return e[1].p
            }))), (function(n) {
              return Eo(Promise.all(n.map(Co((function(n) {
                var o = !1,
                  r = [],
                  i = ao(t.splice(0, 1), 1),
                  a = ao(i[0], 7),
                ...
                return function(e, t) {
                  ...
                  if (s && f) return Eo(g.p, (function(t) {
                    l[u] = t;
                    var n = m(e, r);
                    return o = !0, n
                  }))
                }), (function(t) {
                  return o ? t : (s ? l[u] = g : e = f ? g.p : g, m(e, r))
                }))
              })))), (function() {
                return e
              }))
          ...
          g = function(e, t, n) {
            Object.assign(e, t);
            var o = xo.map((function(t) {
              var n = e[t];
              return delete e[t], n
            }));
            n(), xo.forEach((function(t, n) {
              e[t] = o[n]
            }))
          },
          h = function(e, t, n, i, d, l, p) {
            var m, y = {},
              w = co(t),
              v = u ? function(o) {
                var r, a = null !== (r = null != p ? p : i.type) && void 0 !== r ? r : _o(t);
                u(Object.assign(null != o ? o : y, {
                  ...
                  awaitingTypesonPromise: fo(t, uo)
                }, {
                  type: a
                }))
              } : null;
            if (["string", "boolean", "number", "undefined"].includes(w)) return void 0 === t || Number.isNaN(t) || t === Number.NEGATIVE_INFINITY || t === Number.POSITIVE_INFINITY || 0 === t ? (m = i.replaced ? t : f(e, t, i, d, !1, l, v)) !== t && (y = {
              replaced: m
            }) : m = t, v && v(), m;
            if (null === t) return v && v(), t;
            if (n && !i.iterateIn && !i.iterateUnsetNumeric && t && "object" === co(t)) {
              var b = s.indexOf(t);
            ...
            var k, A = yo(t),
              S = Po(t),
              _ = (A || S) && (!o.plainObjectReplacers.length || i.replaced) || i.iterateIn ? t : f(e, t, i, d, A || S, null, v);
            if (_ !== t ? (m = _, y = {
                replaced: _
              }) : "" === e && fo(t, uo) ? (d.push([e, t, n, i, void 0, void 0, i.type]), m = t) : S && "object" !== i.iterateIn || "array" === i.iterateIn ? (k = new Array(t.length), y = {
                clone: k
              }) : (["function", "symbol"].includes(co(t)) || "toJSON" in t || fo(t, uo) || fo(t, Promise) || fo(t, ArrayBuffer)) && !A && "object" !== i.iterateIn ? m = t : (k = {}, i.addLength && (k.length = t.length), y = {
                clone: k
            ...
            if (i.iterateIn) {
              var E = function(o) {
                ...
                g(i, r, (function() {
                  var r = e + (e ? "." : "") + bo(o),
                    a = h(r, t[o], Boolean(n), i, d, l);
                  fo(a, uo) ? d.push([r, a, Boolean(n), i, k, o, i.type]) : void 0 !== a && (k[o] = a)
                }))
              };
              for (var I in t) E(I);
              v && v({
            ...
            } else Io(t).forEach((function(o) {
              var r = e + (e ? "." : "") + bo(o);
              g(i, {
                ownKeys: !0
              }, (function() {
                var e = h(r, t[o], Boolean(n), i, d, l);
                fo(e, uo) ? d.push([r, e, Boolean(n), i, k, o, i.type]) : void 0 !== e && (k[o] = e)
              }))
            })), v && v({
              endIterateOwn: !0,
              end: !0
            ...
            if (i.iterateUnsetNumeric) {
              for (var T = t.length, P = function(o) {
                  if (!(o in t)) {
                    var r = "".concat(e).concat(e ? "." : "").concat(String(o));
                    g(i, {
                      ownKeys: !1
                    }, (function() {
                      var e = h(r, void 0, Boolean(n), i, d, l);
                      fo(e, uo) ? d.push([r, e, Boolean(n), i, k, o, i.type]) : void 0 !== e && (k[o] = e)
                    }))
                  }
                }, x = 0; x < T; x++) P(x);
          ...
          f = function(e, t, n, r, s, c, d) {
            for (var u = s ? o.plainObjectReplacers : o.nonplainObjectReplacers, p = u.length; p--;) {
              ...
              if (m.test(t, n)) {
                ...
                return h(e, y, l && "readonly", n, r, c, g)
              }
            }
            return t
          },
      ...
      key: "encapsulateSync",
      value: function(e, t, n) {
        return this.encapsulate(e, t, io(io({
          throwOnBadSyncType: !0
        }, n), {}, {
          sync: !0
        }))
      ...
      value: function(e, t) {
        ...
        if (!e || "object" !== co(e) || Array.isArray(e)) return i(e);
        var a = e.$types;
        if (!0 === a) return i(e.$);
        if (!a || "object" !== co(a) || Array.isArray(a)) return i(e);
        var s = [],
          c = {},
          d = !0;
        a.$ && yo(a.$) && (e = e.$, a = a.$, d = !1);
        var l = function(e, t) {
            var o, i = ao(null !== (o = n.revivers[e]) && void 0 !== o ? o : [], 1)[0];
        ...
        var m, g = function() {
          ...
          if (Object.entries(a).forEach((function(e) {
              ...
              "#" !== i && [].concat(i).forEach((function(e) {
                var o;
                ao(null !== (o = n.revivers[e]) && void 0 !== o ? o : [null, {}], 2)[1].plain && (t.push({
                  keypath: r,
                  type: e
                }), delete a[r])
              }))
            })), t.length) return t.sort(Oo), t.reduce((function t(n, o) {
            var r = o.keypath,
              i = o.type;
            if (go(n)) return n.then((function(e) {
              return t(e, {
                keypath: r,
                type: i
              })
            ...
            var a = Ao(e, r);
            if (fo(a = l(i, a), uo)) return a.then((function(t) {
              var n = So(e, r, t);
              n === t && (e = n)
            }));
            var s = So(e, r, a);
        ...
        return fo(g, uo) ? m = g.then((function() {
          return e
          ...
          if (!d || "$types" !== t) {
            ...
            if (p || yo(n)) {
              ...
              for (Io(n).forEach((function(r) {
                  var i = e(t + (t ? "." : "") + bo(r), n[r], null != o ? o : m, m, r),
                    a = function(e) {
                      return fo(e, Lo) ? m[r] = void 0 : void 0 !== e && (m[r] = e), e
                    };
                  fo(i, uo) ? u.push(i.then((function(e) {
                    return a(e)
                  }))) : a(i)
                })), n = m; s.length;) {
                var g = ao(s[0], 4),
        ...
        }("", e, null), u.length && (m = uo.resolve(m).then((function(e) {
          return uo.all([e].concat(u))
        })).then((function(e) {
          return ao(e, 1)[0]
        })))), go(m) ? r && o.throwOnBadSyncType ? function() {
          throw new TypeError("Sync method requested but async result obtained")
        }() : fo(m, uo) ? m.p.then(p) : m : !r && o.throwOnBadSyncType ? function() {
  ...
  for (var Mo = ["null", "boolean", "number", "string", "array", "object"], Bo = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", No = new Uint8Array(256), Ro = 0; Ro < 64; Ro++) No[Bo.codePointAt(Ro)] = Ro;
  var jo = function(e, t, n) {
      null == n && (n = e.byteLength);
      for (var o = new Uint8Array(e, 0, n), r = o.length, i = "", a = 0; a < r; a += 3) i += Bo[o[a] >> 2], i += Bo[(3 & o[a]) << 4 | o[a + 1] >> 4], i += Bo[(15 & o[a + 1]) << 2 | o[a + 2] >> 6], i += Bo[63 & o[a + 2]];
    ...
    Vo = function(e, t) {
      ...
      for (var d = new ArrayBuffer(s, t), l = new Uint8Array(d), u = 0; u < n; u += 4) o = No[e.codePointAt(u)], r = No[e.codePointAt(u + 1)], i = No[e.codePointAt(u + 2)], a = No[e.codePointAt(u + 3)], l[c++] = o << 2 | r >> 4, l[c++] = (15 & r) << 4 | i >> 2, l[c++] = (3 & i) << 6 | 63 & a;
      return d
    };
  const Go = {
      arraybuffer: {
        test: e => "ArrayBuffer" === ho(e),
        replace(e, t) {
          t.buffers || (t.buffers = []);
    ...
    Fo = {
      bigintObject: {
        test: e => "object" == typeof e && fo(e, BigInt),
        replace: String,
  ...
  const Ho = {
    blob: {
      ...
      replaceAsync: e => new uo(((t, n) => {
        const o = new FileReader;
        o.addEventListener("load", (() => {
          t({
            type: e.type,
            stringContents: Ko(o.result)
          })
  ...
  const qo = {
      cryptokey: {
        test: e => "CryptoKey" === ho(e) && e.extractable,
        replaceAsync: e => new uo((async (t, n) => {
          let o;
          try {
    ...
    Yo = {
      dataview: {
        ...
        revive(e, t) {
          ...
          let c;
          return "index" in e ? c = t.buffers[i] : (c = Vo(r, s ? {
            maxByteLength: a
  ...
  "undefined" != typeof DOMMatrix && Qo(DOMMatrix), "undefined" != typeof DOMMatrixReadOnly && Qo(DOMMatrixReadOnly);
  const Zo = {};
  ...
  "undefined" != typeof DOMPoint && Xo(DOMPoint), "undefined" != typeof DOMPointReadOnly && Xo(DOMPointReadOnly);
  const er = {
      domquad: {
        test: e => "DOMQuad" === ho(e),
        replace: e => ({
  ...
  "undefined" != typeof DOMRect && nr(DOMRect), "undefined" != typeof DOMRectReadOnly && nr(DOMRectReadOnly);
  const or = {
      error: {
        test: e => "Error" === ho(e),
        replace: ({
  ...
  } [TypeError, RangeError, SyntaxError, ReferenceError, EvalError, URIError].forEach((e => ir(e))), "undefined" != typeof AggregateError && ir(AggregateError), "function" == typeof InternalError && ir(InternalError);
  const ar = {
      file: {
        test: e => "File" === ho(e),
        replace(e) {
        ...
        replaceAsync: e => new uo((function(t, n) {
          const o = new FileReader;
    ...
    cr = {
      imagebitmap: {
        test: e => "ImageBitmap" === ho(e) || e && e.dataset && "ImageBitmap" === e.dataset.toStringTag,
        replace(e) {
          const t = document.createElement("canvas");
        ...
        reviveAsync(e) {
          ...
          return o.addEventListener("load", (function() {
            n.drawImage(o, 0, 0)
          })), o.src = e.dataURL, new uo((async (e, n) => {
            try {
    ...
    pr = {
      IntlCollator: ur,
      IntlDateTimeFormat: {
        test: e => fo(e, Intl.DateTimeFormat),
        replace: e => e.resolvedOptions(),
        revive: e => new Intl.DateTimeFormat(e.locale, e)
      },
      IntlNumberFormat: {
        test: e => fo(e, Intl.NumberFormat),
        replace: e => e.resolvedOptions(),
    ...
    yr = {
      StringObject: {
        test: e => "String" === ho(e) && "object" == typeof e,
        replace: String,
        revive: e => new String(e)
      },
      BooleanObject: {
        test: e => "Boolean" === ho(e) && "object" == typeof e,
        replace: e => e.valueOf(),
        revive: e => new Boolean(e)
      },
      NumberObject: {
        test: e => "Number" === ho(e) && "object" == typeof e,
        replace: Number,
  ...
  "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach((e => function(e) {
    ...
    br[t.toLowerCase()] = {
      ...
      revive: t => "ArrayBuffer" === ho(t) ? new e(t) : t
    }
  }(e)));
  const kr = {};
  "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach((e => function(e) {
    ...
    kr[t.toLowerCase()] = {
      ...
      revive(t, n) {
        ...
        let d;
        return "index" in t ? d = n.buffers[a] : (d = Vo(i, c ? {
          maxByteLength: s
  ...
  function Pr(e, t, n, o, r, i) {
    return Lr(function(e, t) {
      return e << t | e >>> 32 - t
    }(Lr(Lr(t, e), Lr(o, i)), r), n)
  }

  function xr(e, t, n, o, r, i, a) {
    return Pr(t & n | ~t & o, e, t, r, i, a)
  }

  function Cr(e, t, n, o, r, i, a) {
    return Pr(t & o | n & ~o, e, t, r, i, a)
  }

  function Or(e, t, n, o, r, i, a) {
    return Pr(t ^ n ^ o, e, t, r, i, a)
  }

  function Dr(e, t, n, o, r, i, a) {
    return Pr(n ^ (t | ~o), e, t, r, i, a)
  }
  ...
  try {
    ...
    }(e), Mr = localStorage.getItem("savegame_idbfs_hash")
  } catch {}
  ...
  async function Fr() {
    ...
    const e = await indexedDB.databases();
    0 === e.length && (console.info("%cPOKI_SAVEGAME:%c No databases found, using IDBDatabaseInfos", "font-weight: bold", "", Vr.map((e => e.name))), e.push(...Vr));
    const t = [];
    e.forEach((async e => {
      var n;
  ...
  class zr {
    ...
    init = e => {
      ...
      Xn(), V.cloudSaveGames && function() {
        console.info("%cPOKI_SAVEGAME:%c setupCloudSaveExports", "font-weight: bold", "");
        const e = (new Do).register([Ir]),
          t = () => {
            const t = Date.now(),
              n = Math.ceil((t - Gr) / 1e3);
            Gr = t;
            try {
              const t = {};
              Object.keys(localStorage).forEach((e => {
                ...
                console.info("%cPOKI_SAVEGAME:%c Sending export", "font-weight: bold", "", r), window?.top?.postMessage({
                  type: "mutateSaveGame",
                  content: r
                }, "*")
              }))
        ...
        function n(e, t) {
          ...
          Vr.find((n => n.name === e && n.version === t)) || Vr.push(n)
        }
        Zn(`(${function(){window.addEventListener("storage",(()=>{window?.parent?.postMessage({type:"LocalStorageChanged"},"*")}))}.toString()})();`);
        const o = Tr((() => {
          console.info("%cPOKI_SAVEGAME:%c Local Storage changed", "font-weight: bold", ""), t()
        }), Rr, jr);
        window.addEventListener("message", (async e => {
          "LocalStorageChanged" === e?.data?.type && o()
        }));
        const r = Tr((() => {
      ...
      Qn().then((e => {
        if (this.#C = e?.adTiming || $n.adTiming, this.#L = e?.specialConditions || [], O() || D() ? this.#C = {
            startAdsAfter: 36e4,
            timeBetweenAds: 36e4
          } : this.#C = {
            startAdsAfter: 12e4,
    ...
    requestAd(t) {
      ...
      if (this.#D === Ur) this.#D = Kr, this.#x[a] = {
        position: r,
        onStart: () => {
    ...
    displayAd(e) {
      ...
      const a = t.getAttribute("data-poki-ad-container-id") || xn();
        ...
        case "hoist_videoAd_onFinish": {
          ...
          if (n) {
            ...
            if (this.#D === Kr) {
              ...
              return this.#D = Ur, void delete this.#x[t]
            }
            if (r) try {
              r(o)
            } catch (e) {
            ...
            z.dispatchEvent(e.playtest.stopVideo), this.#D = Ur, delete this.#x[t]
          }
          break
        }
  ...
  const Hr = new class extends Wn {
    constructor() {
      super(new zr, !0), window.addEventListener("message", this.__monetization.handleMessageReceived)
    }
  };
  for (const e in Hr) e.startsWith("__") || (window.PokiSDK[e] = Hr[e])
})();